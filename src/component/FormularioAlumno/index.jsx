        ...
        <form onSubmit={manejoFormulario} action="" className='form'>
            ...
            <fieldset className='form_field'>
                ...
                <div className='form_div'>
                    ...
                    <input value={dat?contraseña:""} onChange={(e) => setConfContraseña(e.target.value)} type="password" name="confContraseña" id="confContraseña" required/>
                </div>
                <div className='form_div'>
